...
An earlier text [here](../lispbm-chibios_repl/index.html) showed an
...
can be found [here](../lispbm-current_status/index.html). 
...
in [the ChibiOS REPL](../lispbm-chibios_repl/index.html). So I wont go into any
detail of this here.
...
post](../lispbm-current_status/index.html) for more information on the
